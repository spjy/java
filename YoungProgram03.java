...
public class YoungProgram03 {
	public static void main (String[] args) {
		...
		inputString5 = JOptionPane.showInputDialog("Can you remember the last question I asked you?");
		if (inputString5.equals("What is your favorite thing to do?")) {
			JOptionPane.showMessageDialog(null, "Right :D");
		} else {
